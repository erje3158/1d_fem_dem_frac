...
bool root6(REAL coef1[],REAL coef2[],vec& point){
	...
	rtc[0]=
	   ...
	   16*b2*c1*e1*h1*i1*a1_2 - 
	   16*b1*c2*e1*h1*i1*a1_2 + 
	   16*b1*c1*e2*h1*i1*a1_2 + 
	   16*b1*c1*e1*h2*i1*a1_2 + 
	   16*b1*c1*e1*h1*i2*a1_2 - 
	   16*a2*c1*f1*g1*i1*b1_2 - 
	   16*a1*c2*f1*g1*i1*b1_2 + 
	   16*a1*c1*f2*g1*i1*b1_2 + 
	   16*a1*c1*f1*g2*i1*b1_2 + 
	   16*a1*c1*f1*g1*i2*b1_2 - 
	   32*c1*i1*i2*a1_2*b1_2 - 
	   16*a2*b1*d1*g1*h1*c1_2 - 
	   16*a1*b2*d1*g1*h1*c1_2 + 
	   16*a1*b1*d2*g1*h1*c1_2 + 
	   16*a1*b1*d1*g2*h1*c1_2 + 
	   16*a1*b1*d1*g1*h2*c1_2 - 
	   32*b1*h1*h2*a1_2*c1_2 - 
	   32*a1*g1*g2*b1_2*c1_2 + 
	   64*j2*a1_2*b1_2*c1_2 + 
	   2*c2*e1*f1*g1*h1*d1_2 - 
	   2*c1*e2*f1*g1*h1*d1_2 - 
	   2*c1*e1*f2*g1*h1*d1_2 + 
	   6*c1*e1*f1*g2*h1*d1_2 + 
	   6*c1*e1*f1*g1*h2*d1_2 - 
	   2*c1*d2*e1*g1*i1*d1_2 - 
	   4*b2*c1*f1*g1*i1*d1_2 + 
	   4*b1*c2*f1*g1*i1*d1_2 - 
	   4*b1*c1*f2*g1*i1*d1_2 - 
	   4*b1*c1*f1*g2*i1*d1_2 - 
	   4*a2*c1*e1*h1*i1*d1_2 + 
	   4*a1*c2*e1*h1*i1*d1_2 - 
	   4*a1*c1*e2*h1*i1*d1_2 - 
	   2*c1*d2*f1*h1*i1*d1_2 - 
	   4*a1*c1*e1*h2*i1*d1_2 - 
	   4*b1*c1*f1*g1*i2*d1_2 - 
	   4*a1*c1*e1*h1*i2*d1_2 + 
	   16*a1*b1*c1*i1*i2*d1_2 + 
	   8*b1*g1*g2*c1_2*d1_2 + 
	   4*d2*g1*h1*c1_2*d1_2 + 
	   8*a1*h1*h2*c1_2*d1_2 - 
	   32*a1*b1*j2*c1_2*d1_2 - 
	   2*c2*e1*g1*i1*d1_3 + 2*c1*e2*g1*i1*d1_3 + 
	   2*c1*e1*g2*i1*d1_3 - 2*c2*f1*h1*i1*d1_3 + 
	   2*c1*f2*h1*i1*d1_3 + 2*c1*f1*h2*i1*d1_3 + 
	   2*c1*e1*g1*i2*d1_3 + 2*c1*f1*h1*i2*d1_3 + 
	   2*e1*f1*i1*i2*d1_3 - 8*c1*e1*f1*j2*d1_3 - 
	   4*g2*h1*c1_2*d1_3 - 
	   4*g1*h2*c1_2*d1_3 - 2*c1*i1*i2*d1_4 + 
	   4*j2*c1_2*d1_4 + 
	   16*a1*b1*c1*g1*g2*e1_2 + 
	   4*a2*c1*d1*g1*h1*e1_2 - 
	   4*a1*c2*d1*g1*h1*e1_2 - 
	   4*a1*c1*d2*g1*h1*e1_2 - 
	   2*a1*e2*f1*g1*h1*e1_2 - 
	   4*a1*c1*d1*g2*h1*e1_2 - 
	   4*a1*c1*d1*g1*h2*e1_2 - 
	   2*a1*d1*e2*g1*i1*e1_2 + 
	   4*a2*b1*f1*g1*i1*e1_2 - 
	   4*a1*b2*f1*g1*i1*e1_2 - 
	   4*a1*b1*f2*g1*i1*e1_2 - 
	   4*a1*b1*f1*g2*i1*e1_2 + 
	   2*a2*d1*f1*h1*i1*e1_2 - 
	   2*a1*d2*f1*h1*i1*e1_2 - 
	   2*a1*d1*f2*h1*i1*e1_2 + 
	   6*a1*d1*f1*h2*i1*e1_2 - 
	   4*a1*b1*f1*g1*i2*e1_2 + 
	   6*a1*d1*f1*h1*i2*e1_2 + 
	   8*c1*h1*h2*a1_2*e1_2 + 
	   4*e2*h1*i1*a1_2*e1_2 + 
	   8*b1*i1*i2*a1_2*e1_2 - 
	   32*b1*c1*j2*a1_2*e1_2 - 
	   2*c1*g1*g2*d1_2*e1_2 + 
	   2*f2*g1*i1*d1_2*e1_2 - 
	   2*f1*g2*i1*d1_2*e1_2 - 
	   2*f1*g1*i2*d1_2*e1_2 - 
	   2*a1*i1*i2*d1_2*e1_2 + 
	   8*a1*c1*j2*d1_2*e1_2 + 
	   2*d1*f1*g1*g2*e1_3 - 2*a2*f1*g1*h1*e1_3 + 
	   2*a1*f2*g1*h1*e1_3 + 2*a1*f1*g2*h1*e1_3 + 
	   2*a1*f1*g1*h2*e1_3 - 2*a2*d1*g1*i1*e1_3 + 
	   2*a1*d2*g1*i1*e1_3 + 2*a1*d1*g2*i1*e1_3 + 
	   2*a1*d1*g1*i2*e1_3 - 8*a1*d1*f1*j2*e1_3 - 
	   4*h2*i1*a1_2*e1_3 - 
	   4*h1*i2*a1_2*e1_3 - 2*a1*g1*g2*e1_4 + 
	   4*j2*a1_2*e1_4 + 4*b2*c1*d1*g1*h1*f1_2 - 
	   4*b1*c2*d1*g1*h1*f1_2 - 
	   4*b1*c1*d2*g1*h1*f1_2 - 
	   2*b1*e1*f2*g1*h1*f1_2 - 
	   4*b1*c1*d1*g2*h1*f1_2 - 
	   4*b1*c1*d1*g1*h2*f1_2 + 
	   16*a1*b1*c1*h1*h2*f1_2 + 
	   2*b2*d1*e1*g1*i1*f1_2 - 
	   2*b1*d2*e1*g1*i1*f1_2 - 
	   2*b1*d1*e2*g1*i1*f1_2 + 
	   6*b1*d1*e1*g2*i1*f1_2 - 
	   4*a2*b1*e1*h1*i1*f1_2 + 
	   4*a1*b2*e1*h1*i1*f1_2 - 
	   4*a1*b1*e2*h1*i1*f1_2 - 
	   2*b1*d1*f2*h1*i1*f1_2 - 
	   4*a1*b1*e1*h2*i1*f1_2 + 
	   6*b1*d1*e1*g1*i2*f1_2 - 
	   4*a1*b1*e1*h1*i2*f1_2 + 
	   8*c1*g1*g2*b1_2*f1_2 + 
	   4*f2*g1*i1*b1_2*f1_2 + 
	   8*a1*i1*i2*b1_2*f1_2 - 
	   32*a1*c1*j2*b1_2*f1_2 - 
	   2*c1*h1*h2*d1_2*f1_2 + 
	   2*e2*h1*i1*d1_2*f1_2 - 
	   2*e1*h2*i1*d1_2*f1_2 - 
	   2*e1*h1*i2*d1_2*f1_2 - 
	   2*b1*i1*i2*d1_2*f1_2 + 
	   8*b1*c1*j2*d1_2*f1_2 - 
	   2*b1*g1*g2*e1_2*f1_2 + 
	   2*d2*g1*h1*e1_2*f1_2 - 
	   2*d1*g2*h1*e1_2*f1_2 - 
	   2*d1*g1*h2*e1_2*f1_2 - 
	   2*a1*h1*h2*e1_2*f1_2 + 
	   8*a1*b1*j2*e1_2*f1_2 + 
	   4*j2*d1_2*e1_2*f1_2 - 
	   2*b2*e1*g1*h1*f1_3 + 2*b1*e2*g1*h1*f1_3 + 
	   2*b1*e1*g2*h1*f1_3 + 2*b1*e1*g1*h2*f1_3 + 
	   2*d1*e1*h1*h2*f1_3 - 2*b2*d1*h1*i1*f1_3 + 
	   2*b1*d2*h1*i1*f1_3 + 2*b1*d1*h2*i1*f1_3 + 
	   2*b1*d1*h1*i2*f1_3 - 8*b1*d1*e1*j2*f1_3 - 
	   4*g2*i1*b1_2*f1_3 - 
	   4*g1*i2*b1_2*f1_3 - 2*b1*h1*h2*f1_4 + 
	   4*j2*b1_2*f1_4 - 4*b2*c1*d1*e1*f1*g1_2 - 
	   4*b1*c2*d1*e1*f1*g1_2 + 
	   4*b1*c1*d2*e1*f1*g1_2 + 
	   4*b1*c1*d1*e2*f1*g1_2 + 
	   4*b1*c1*d1*e1*f2*g1_2 - 
	   8*c1*f1*f2*b1_2*g1_2 - 
	   8*b1*d1*d2*c1_2*g1_2 + 
	   16*a2*b1_2*c1_2*g1_2 - 
	   2*c1*e1*e2*d1_2*g1_2 + 
	   4*b2*c1_2*d1_2*g1_2 - 
	   8*a2*b1*c1*e1_2*g1_2 + 
	   2*c1*d1*d2*e1_2*g1_2 + 
	   d1*e2*f1*e1_2*g1_2 + 
	   2*b1*f1*f2*e1_2*g1_2 + 
	   c2*d1_2*e1_2*g1_2 - 
	   d2*f1*e1_3*g1_2 - d1*f2*e1_3*g1_2 + 
	   a2*e1_4*g1_2 - 
	   2*b1*e1*e2*f1_2*g1_2 + 
	   4*c2*b1_2*f1_2*g1_2 + 
	   b2*e1_2*f1_2*g1_2 - 
	   4*a2*c1*d1*e1*f1*h1_2 - 
	   4*a1*c2*d1*e1*f1*h1_2 + 
	   4*a1*c1*d2*e1*f1*h1_2 + 
	   4*a1*c1*d1*e2*f1*h1_2 + 
	   4*a1*c1*d1*e1*f2*h1_2 - 
	   8*c1*e1*e2*a1_2*h1_2 - 
	   8*a1*d1*d2*c1_2*h1_2 + 
	   16*b2*a1_2*c1_2*h1_2 - 
	   2*c1*f1*f2*d1_2*h1_2 + 
	   4*a2*c1_2*d1_2*h1_2 - 
	   2*a1*f1*f2*e1_2*h1_2 + 
	   4*c2*a1_2*e1_2*h1_2 - 
	   8*a1*b2*c1*f1_2*h1_2 + 
	   2*c1*d1*d2*f1_2*h1_2 + 
	   2*a1*e1*e2*f1_2*h1_2 + 
	   d1*e1*f2*f1_2*h1_2 + 
	   c2*d1_2*f1_2*h1_2 + 
	   a2*e1_2*f1_2*h1_2 - 
	   d2*e1*f1_3*h1_2 - d1*e2*f1_3*h1_2 + 
	   b2*f1_4*h1_2 - 4*a2*b1*d1*e1*f1*i1_2 - 
	   4*a1*b2*d1*e1*f1*i1_2 + 
	   4*a1*b1*d2*e1*f1*i1_2 + 
	   4*a1*b1*d1*e2*f1*i1_2 + 
	   4*a1*b1*d1*e1*f2*i1_2 - 
	   8*b1*e1*e2*a1_2*i1_2 - 
	   8*a1*f1*f2*b1_2*i1_2 + 
	   16*c2*a1_2*b1_2*i1_2 - 
	   8*a1*b1*c2*d1_2*i1_2 + 
	   2*a1*e1*e2*d1_2*i1_2 + 
	   d2*e1*f1*d1_2*i1_2 + 
	   2*b1*f1*f2*d1_2*i1_2 - 
	   e2*f1*d1_3*i1_2 - e1*f2*d1_3*i1_2 + 
	   c2*d1_4*i1_2 - 
	   2*a1*d1*d2*e1_2*i1_2 + 
	   4*b2*a1_2*e1_2*i1_2 + 
	   a2*d1_2*e1_2*i1_2 - 
	   2*b1*d1*d2*f1_2*i1_2 + 
	   4*a2*b1_2*f1_2*i1_2 + 
	   b2*d1_2*f1_2*i1_2;
	rtc[1]=
   ...
   2*d1*e1*f1*i2*(-(d2*e1*g1) - d1*e2*g1 + 2*b2*f1*g1 + 
      ...
      d1*f1*h2 - 4*a2*b1*i1 - 4*a1*b2*i1 + 2*d1*d2*i1 - 
      4*a1*b1*i2 + i2*d1_2) + 
   2*c2*i1*d1_2*(-(d2*e1*g1) - d1*e2*g1 + 
      ...
      2*d1*d2*i1 - 4*a1*b1*i2 + i2*d1_2) - 
   2*c1*i2*d1_2*(-(d2*e1*g1) - d1*e2*g1 + 
      2*b2*f1*g1 + 2*b1*f2*g1 - d1*e1*g2 + 2*b1*f1*g2 + 
      2*a2*e1*h1 + 2*a1*e2*h1 - d2*f1*h1 - d1*f2*h1 + 
      2*a1*e1*h2 - d1*f1*h2 - 4*a2*b1*i1 - 4*a1*b2*i1 + 
      2*d1*d2*i1 - 4*a1*b1*i2 + i2*d1_2) + 
   ...
   4*a1*b1*f2*i1*(-4*b2*c1*g1 - 4*b1*c2*g1 + 2*e1*e2*g1 - 
      ...
      d1*e2*i1 + 2*b2*f1*i1 + 2*b1*f2*i1 - d1*e1*i2 + 
      2*b1*f1*i2 + g2*e1_2) - 
   2*c1*g2*d1_2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 
      2*e1*e2*g1 - 4*b1*c1*g2 + 2*c2*d1*h1 + 2*c1*d2*h1 - 
      e2*f1*h1 - e1*f2*h1 + 2*c1*d1*h2 - e1*f1*h2 - 
      d2*e1*i1 - d1*e2*i1 + 2*b2*f1*i1 + 2*b1*f2*i1 - 
      d1*e1*i2 + 2*b1*f1*i2 + g2*e1_2) + 
   f2*i1*d1_2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 
      2*e1*e2*g1 - 4*b1*c1*g2 + 2*c2*d1*h1 + 2*c1*d2*h1 - 
      e2*f1*h1 - e1*f2*h1 + 2*c1*d1*h2 - e1*f1*h2 - 
      d2*e1*i1 - d1*e2*i1 + 2*b2*f1*i1 + 2*b1*f2*i1 - 
      d1*e1*i2 + 2*b1*f1*i2 + g2*e1_2) + 
   2*a2*g1*e1_2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 
      2*e1*e2*g1 - 4*b1*c1*g2 + 2*c2*d1*h1 + 2*c1*d2*h1 - 
      e2*f1*h1 - e1*f2*h1 + 2*c1*d1*h2 - e1*f1*h2 - 
      d2*e1*i1 - d1*e2*i1 + 2*b2*f1*i1 + 2*b1*f2*i1 - 
      d1*e1*i2 + 2*b1*f1*i2 + g2*e1_2) - 
   2*a1*g2*e1_2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 
      2*e1*e2*g1 - 4*b1*c1*g2 + 2*c2*d1*h1 + 2*c1*d2*h1 - 
      e2*f1*h1 - e1*f2*h1 + 2*c1*d1*h2 - e1*f1*h2 - 
      d2*e1*i1 - d1*e2*i1 + 2*b2*f1*i1 + 2*b1*f2*i1 - 
      d1*e1*i2 + 2*b1*f1*i2 + g2*e1_2) + 
   ...
   4*b1*c1*g1*g2*(8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 
      ...
      2*d1*e1*f2 - 4*b1*f1*f2 - 2*c2*d1_2 - 
      2*a2*e1_2 - 2*b2*f1_2) + 
   ...
   4*d1*e1*f1*j2*(8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 
      ...
      2*d1*e1*f2 - 4*b1*f1*f2 - 2*c2*d1_2 - 
      2*a2*e1_2 - 2*b2*f1_2) + 
   i1*i2*d1_2*(8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 
      4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 2*d1*e2*f1 + 
      2*d1*e1*f2 - 4*b1*f1*f2 - 2*c2*d1_2 - 
      2*a2*e1_2 - 2*b2*f1_2) - 
   4*c1*j2*d1_2*(8*a2*b1*c1 + 8*a1*b2*c1 + 
      8*a1*b1*c2 - 4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 
      2*d1*e2*f1 + 2*d1*e1*f2 - 4*b1*f1*f2 - 
      2*c2*d1_2 - 2*a2*e1_2 - 2*b2*f1_2) + 
   g1*g2*e1_2*(8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 
      4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 2*d1*e2*f1 + 
      2*d1*e1*f2 - 4*b1*f1*f2 - 2*c2*d1_2 - 
      2*a2*e1_2 - 2*b2*f1_2) - 
   4*a1*j2*e1_2*(8*a2*b1*c1 + 8*a1*b2*c1 + 
      8*a1*b1*c2 - 4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 
      2*d1*e2*f1 + 2*d1*e1*f2 - 4*b1*f1*f2 - 
      2*c2*d1_2 - 2*a2*e1_2 - 2*b2*f1_2) + 
   h1*h2*f1_2*(8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 
      4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 2*d1*e2*f1 + 
      2*d1*e1*f2 - 4*b1*f1*f2 - 2*c2*d1_2 - 
      2*a2*e1_2 - 2*b2*f1_2) - 
   4*b1*j2*f1_2*(8*a2*b1*c1 + 8*a1*b2*c1 + 
      8*a1*b1*c2 - 4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 
      2*d1*e2*f1 + 2*d1*e1*f2 - 4*b1*f1*f2 - 
      2*c2*d1_2 - 2*a2*e1_2 - 2*b2*f1_2) + 
   ...
   2*b1*d2*f1*i1*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      ...
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) - 
   2*c1*h2*d1_2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) + 
   e2*i1*d1_2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) + 
   d2*g1*e1_2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) - 
   2*a1*h2*e1_2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) + 
   2*b2*h1*f1_2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) - 
   2*b1*h2*f1_2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2);
   ...
   4*a1*b1*f2*i1*(-4*b2*c2*g1 - 4*b2*c1*g2 - 4*b1*c2*g2 + 
      ...
      2*b2*f2*i1 - d2*e1*i2 - d1*e2*i2 + 2*b2*f1*i2 + 
      2*b1*f2*i2 + g1*e2_2) - 
   2*c1*g2*d1_2*(-4*b2*c2*g1 - 4*b2*c1*g2 - 
      4*b1*c2*g2 + 2*e1*e2*g2 + 2*c2*d2*h1 - e2*f2*h1 + 
      2*c2*d1*h2 + 2*c1*d2*h2 - e2*f1*h2 - e1*f2*h2 - 
      d2*e2*i1 + 2*b2*f2*i1 - d2*e1*i2 - d1*e2*i2 + 
      2*b2*f1*i2 + 2*b1*f2*i2 + g1*e2_2) + 
   f2*i1*d1_2*(-4*b2*c2*g1 - 4*b2*c1*g2 - 
      4*b1*c2*g2 + 2*e1*e2*g2 + 2*c2*d2*h1 - e2*f2*h1 + 
      2*c2*d1*h2 + 2*c1*d2*h2 - e2*f1*h2 - e1*f2*h2 - 
      d2*e2*i1 + 2*b2*f2*i1 - d2*e1*i2 - d1*e2*i2 + 
      2*b2*f1*i2 + 2*b1*f2*i2 + g1*e2_2) + 
   2*a2*g1*e1_2*(-4*b2*c2*g1 - 4*b2*c1*g2 - 
      4*b1*c2*g2 + 2*e1*e2*g2 + 2*c2*d2*h1 - e2*f2*h1 + 
      2*c2*d1*h2 + 2*c1*d2*h2 - e2*f1*h2 - e1*f2*h2 - 
      d2*e2*i1 + 2*b2*f2*i1 - d2*e1*i2 - d1*e2*i2 + 
      2*b2*f1*i2 + 2*b1*f2*i2 + g1*e2_2) - 
   2*a1*g2*e1_2*(-4*b2*c2*g1 - 4*b2*c1*g2 - 
      4*b1*c2*g2 + 2*e1*e2*g2 + 2*c2*d2*h1 - e2*f2*h1 + 
      2*c2*d1*h2 + 2*c1*d2*h2 - e2*f1*h2 - e1*f2*h2 - 
      d2*e2*i1 + 2*b2*f2*i1 - d2*e1*i2 - d1*e2*i2 + 
      2*b2*f1*i2 + 2*b1*f2*i2 + g1*e2_2) + 
   ...
   2*b1*i2*(-(d2*e2*g1) + 2*b2*f2*g1 - d2*e1*g2 - 
      ...
      d2*f2*h1 + 2*a2*e1*h2 + 2*a1*e2*h2 - d2*f1*h2 - 
      d1*f2*h2 - 4*a2*b2*i1 - 4*a2*b1*i2 - 4*a1*b2*i2 + 
      2*d1*d2*i2 + i1*d2_2)*f1_2 - 
   2*b1*g2*(-4*b2*c2*g1 - 4*b2*c1*g2 - 4*b1*c2*g2 + 
      2*e1*e2*g2 + 2*c2*d2*h1 - e2*f2*h1 + 2*c2*d1*h2 + 
      2*c1*d2*h2 - e2*f1*h2 - e1*f2*h2 - d2*e2*i1 + 
      2*b2*f2*i1 - d2*e1*i2 - d1*e2*i2 + 2*b2*f1*i2 + 
      2*b1*f2*i2 + g1*e2_2)*f1_2 + 
   ...
   g2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 2*e1*e2*g1 - 
    ...
    (8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 4*c1*d1*d2 - 
      ...
      4*b1*f1*f2 - 2*c2*d1_2 - 2*a2*e1_2 - 
      2*b2*f1_2) + 
   e2*(-(d2*e1*g1) - d1*e2*g1 + 2*b2*f1*g1 + 2*b1*f2*g1 - 
      d1*e1*g2 + 2*b1*f1*g2 + 2*a2*e1*h1 + 2*a1*e2*h1 - 
      d2*f1*h1 - d1*f2*h1 + 2*a1*e1*h2 - d1*f1*h2 - 
      4*a2*b1*i1 - 4*a1*b2*i1 + 2*d1*d2*i1 - 4*a1*b1*i2 + 
      i2*d1_2)*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) + 
   ...
   4*d1*e1*f1*j2*(8*a2*b2*c1 + 8*a2*b1*c2 + 8*a1*b2*c2 - 
      ...
      2*d1*e2*f2 - 4*b2*f1*f2 - 2*c1*d2_2 - 
      2*a1*e2_2 - 2*b1*f2_2) + 
   i1*i2*d1_2*(8*a2*b2*c1 + 8*a2*b1*c2 + 8*a1*b2*c2 - 
      4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 2*d2*e1*f2 + 
      2*d1*e2*f2 - 4*b2*f1*f2 - 2*c1*d2_2 - 
      2*a1*e2_2 - 2*b1*f2_2) - 
   4*c1*j2*d1_2*(8*a2*b2*c1 + 8*a2*b1*c2 + 
      8*a1*b2*c2 - 4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 
      2*d2*e1*f2 + 2*d1*e2*f2 - 4*b2*f1*f2 - 
      2*c1*d2_2 - 2*a1*e2_2 - 2*b1*f2_2) + 
   g1*g2*e1_2*(8*a2*b2*c1 + 8*a2*b1*c2 + 8*a1*b2*c2 - 
      4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 2*d2*e1*f2 + 
      2*d1*e2*f2 - 4*b2*f1*f2 - 2*c1*d2_2 - 
      2*a1*e2_2 - 2*b1*f2_2) - 
   4*a1*j2*e1_2*(8*a2*b2*c1 + 8*a2*b1*c2 + 
      8*a1*b2*c2 - 4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 
      2*d2*e1*f2 + 2*d1*e2*f2 - 4*b2*f1*f2 - 
      2*c1*d2_2 - 2*a1*e2_2 - 2*b1*f2_2) + 
   h1*h2*f1_2*(8*a2*b2*c1 + 8*a2*b1*c2 + 8*a1*b2*c2 - 
      4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 2*d2*e1*f2 + 
      2*d1*e2*f2 - 4*b2*f1*f2 - 2*c1*d2_2 - 
      2*a1*e2_2 - 2*b1*f2_2) - 
   4*b1*j2*f1_2*(8*a2*b2*c1 + 8*a2*b1*c2 + 
      8*a1*b2*c2 - 4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 
      2*d2*e1*f2 + 2*d1*e2*f2 - 4*b2*f1*f2 - 
      2*c1*d2_2 - 2*a1*e2_2 - 2*b1*f2_2) + 
   ...
   2*b1*d2*f1*i1*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      ...
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) - 
   2*c1*h2*d1_2*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) + 
   e2*i1*d1_2*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) + 
   d2*g1*e1_2*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) - 
   2*a1*h2*e1_2*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) + 
   2*b2*h1*f1_2*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) - 
   2*b1*h2*f1_2*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) + 
   ...
   b2*pow(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - e1*f2*g1 + 
	...
	rtc[3]=
      ...
      d2*f1*h1 - d1*f2*h1 + 2*a1*e1*h2 - d1*f1*h2 - 
      4*a2*b1*i1 - 4*a1*b2*i1 + 2*d1*d2*i1 - 4*a1*b1*i2 + 
      i2*d1_2)*(-(d2*e2*g1) + 2*b2*f2*g1 - d2*e1*g2 - 
      d1*e2*g2 + 2*b2*f1*g2 + 2*b1*f2*g2 + 2*a2*e2*h1 - 
      d2*f2*h1 + 2*a2*e1*h2 + 2*a1*e2*h2 - d2*f1*h2 - 
      d1*f2*h2 - 4*a2*b2*i1 - 4*a2*b1*i2 - 4*a1*b2*i2 + 
      2*d1*d2*i2 + i1*d2_2) - 
   2*c2*d1*e1*g1*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - 
      d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2) + 
   ...
   2*d1*e1*f1*i2*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - 
      d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2) + 
   2*c2*i1*d1_2*(-(d2*e2*g2) + 2*b2*f2*g2 + 
      2*a2*e2*h2 - d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2) - 
   2*c1*i2*d1_2*(-(d2*e2*g2) + 2*b2*f2*g2 + 
      2*a2*e2*h2 - d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2) + 
   f2*g1*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - 
      d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2)*e1_2 - 
   ...
   4*a1*b1*f2*i1*(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - 
      d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2) - 
   2*c1*g2*d1_2*(-4*b2*c2*g2 + 2*c2*d2*h2 - 
      e2*f2*h2 - d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2) + 
   f2*i1*d1_2*(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - 
      d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2) + 
   2*a2*g1*e1_2*(-4*b2*c2*g2 + 2*c2*d2*h2 - 
      e2*f2*h2 - d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2) - 
   2*a1*g2*e1_2*(-4*b2*c2*g2 + 2*c2*d2*h2 - 
      e2*f2*h2 - d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2) + 
   e2*h1*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - 
      d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2)*f1_2 - 
   2*b1*i2*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - 
      d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2)*f1_2 - 
   2*b1*g2*(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - 
      d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2)*f1_2 + 
   d2*h1*(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - d2*e2*i2 + 
      2*b2*f2*i2 + g2*e2_2)*f1_2 + 
   i2*(-(d2*e2*g1) + 2*b2*f2*g1 - d2*e1*g2 - d1*e2*g2 + 
      2*b2*f1*g2 + 2*b1*f2*g2 + 2*a2*e2*h1 - d2*f2*h1 + 
      2*a2*e1*h2 + 2*a1*e2*h2 - d2*f1*h2 - d1*f2*h2 - 
      4*a2*b2*i1 - 4*a2*b1*i2 - 4*a1*b2*i2 + 2*d1*d2*i2 + 
      i1*d2_2)*(8*a2*b1*c1 + 8*a1*b2*c1 + 
      8*a1*b1*c2 - 4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 
      2*d1*e2*f1 + 2*d1*e1*f2 - 4*b1*f1*f2 - 
      2*c2*d1_2 - 2*a2*e1_2 - 2*b2*f1_2) + 
   ...
   e2*(-(d2*e2*g1) + 2*b2*f2*g1 - d2*e1*g2 - d1*e2*g2 + 
      ...
      2*a2*e1*h2 + 2*a1*e2*h2 - d2*f1*h2 - d1*f2*h2 - 
      4*a2*b2*i1 - 4*a2*b1*i2 - 4*a1*b2*i2 + 2*d1*d2*i2 + 
      i1*d2_2)*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - 
      e1*f2*g1 + 2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 
      4*a1*c2*h1 + 2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 
      2*a1*e2*i1 - d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - 
      d1*f1*i2 + h2*f1_2) + 
   ...
   g2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 2*e1*e2*g1 - 
    ...
    (8*a2*b2*c1 + 8*a2*b1*c2 + 8*a1*b2*c2 - 4*c2*d1*d2 - 
      ...
      4*b2*f1*f2 - 2*c1*d2_2 - 2*a1*e2_2 - 
      2*b1*f2_2) + 
   ...
   h2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - e1*f2*g1 + 
      ...
      2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 2*a1*e2*i1 - 
      d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - d1*f1*i2 + 
      h2*f1_2)*(8*a2*b2*c1 + 8*a2*b1*c2 + 
      8*a1*b2*c2 - 4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 
      2*d2*e1*f2 + 2*d1*e2*f2 - 4*b2*f1*f2 - 
      2*c1*d2_2 - 2*a1*e2_2 - 2*b1*f2_2) - 
   4*b1*c1*g1*g2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   2*c1*d1*g2*h1*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   e1*f1*g2*h1*(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2) + 
   2*c1*d1*g1*h2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   e1*f1*g1*h2*(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2) - 
   4*a1*c1*h1*h2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   d1*e1*g2*i1*(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2) + 
   2*b1*f1*g2*i1*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   2*a1*e1*h2*i1*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   d1*f1*h2*i1*(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2) - 
   d1*e1*g1*i2*(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2) + 
   2*b1*f1*g1*i2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   2*a1*e1*h1*i2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   d1*f1*h1*i2*(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2) - 
   ...
   4*d1*e1*f1*j2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   i1*i2*d1_2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   4*c1*j2*d1_2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   g1*g2*e1_2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   4*a1*j2*e1_2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   h1*h2*f1_2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) - 
   4*b1*j2*f1_2*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   e2*(-(d2*e1*g1) - d1*e2*g1 + 2*b2*f1*g1 + 2*b1*f2*g1 - 
      d1*e1*g2 + 2*b1*f1*g2 + 2*a2*e1*h1 + 2*a1*e2*h1 - 
      d2*f1*h1 - d1*f2*h1 + 2*a1*e1*h2 - d1*f1*h2 - 
      4*a2*b1*i1 - 4*a1*b2*i1 + 2*d1*d2*i1 - 4*a1*b1*i2 + 
      i2*d1_2)*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) + 
   d2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 2*e1*e2*g1 - 
    ...
    (8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 4*c1*d1*d2 - 
      ...
      d2*f1*i2 - d1*f2*i2 + h1*f2_2) + 
   2*b2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - e1*f2*g1 + 
      2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 4*a1*c2*h1 + 
      2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 2*a1*e2*i1 - 
      d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - d1*f1*i2 + 
      h2*f1_2)*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) + 
   4*b2*c1*d1*g1*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) - 
   ...
   2*b1*d2*f1*i1*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) - 
   2*c1*h2*d1_2*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   e2*i1*d1_2*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   d2*g1*e1_2*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) - 
   2*a1*h2*e1_2*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   2*b2*h1*f1_2*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) - 
   2*b1*h2*f1_2*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2);
	rtc[4]=
		2*c2*(-(d2*e1*g1) - d1*e2*g1 + 2*b2*f1*g1 + 2*b1*f2*g1 - 
      d1*e1*g2 + 2*b1*f1*g2 + 2*a2*e1*h1 + 2*a1*e2*h1 - 
   ...
   f2*(-(d2*e1*g1) - d1*e2*g1 + 2*b2*f1*g1 + 2*b1*f2*g1 - 
      ...
      d2*f1*h1 - d1*f2*h1 + 2*a1*e1*h2 - d1*f1*h2 - 
      4*a2*b1*i1 - 4*a1*b2*i1 + 2*d1*d2*i1 - 4*a1*b1*i2 + 
      i2*d1_2)*(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - 
      d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2) + 
   2*a2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 2*e1*e2*g1 - 
      4*b1*c1*g2 + 2*c2*d1*h1 + 2*c1*d2*h1 - e2*f1*h1 - 
      e1*f2*h1 + 2*c1*d1*h2 - e1*f1*h2 - d2*e1*i1 - 
   ...
   g2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 2*e1*e2*g1 - 
      ...
      d1*e2*i1 + 2*b2*f1*i1 + 2*b1*f2*i1 - d1*e1*i2 + 
      2*b1*f1*i2 + g2*e1_2)*
    (8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2) + 
   2*j2*(8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 
      4*c1*d1*d2 - 4*a1*e1*e2 + 2*d2*e1*f1 + 2*d1*e2*f1 + 
      2*d1*e1*f2 - 4*b1*f1*f2 - 2*c2*d1_2 - 
   ...
   h2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - e1*f2*g1 + 
      ...
      2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 2*a1*e2*i1 - 
      d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - d1*f1*i2 + 
      h2*f1_2)*(8*a2*b2*c2 + 2*d2*e2*f2 - 
      2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2) + 
   e2*(-(d2*e2*g1) + 2*b2*f2*g1 - d2*e1*g2 - d1*e2*g2 + 
      2*b2*f1*g2 + 2*b1*f2*g2 + 2*a2*e2*h1 - d2*f2*h1 + 
      2*a2*e1*h2 + 2*a1*e2*h2 - d2*f1*h2 - d1*f2*h2 - 
      4*a2*b2*i1 - 4*a2*b1*i2 - 4*a1*b2*i2 + 2*d1*d2*i2 + 
      i1*d2_2)*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 
      2*c1*d2*g2 - e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 
      4*a2*c1*h2 - 4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - 
      d2*f2*i1 + 2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - 
      d1*f2*i2 + h1*f2_2) + 
   ...
   e2*(-(d2*e1*g1) - d1*e2*g1 + 2*b2*f1*g1 + 2*b1*f2*g1 - 
      ...
      d2*f1*h1 - d1*f2*h1 + 2*a1*e1*h2 - d1*f1*h2 - 
      4*a2*b1*i1 - 4*a1*b2*i1 + 2*d1*d2*i1 - 4*a1*b1*i2 + 
      i2*d1_2)*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   d2*(-4*b2*c1*g1 - 4*b1*c2*g1 + 2*e1*e2*g1 - 
      4*b1*c1*g2 + 2*c2*d1*h1 + 2*c1*d2*h1 - e2*f1*h1 - 
      e1*f2*h1 + 2*c1*d1*h2 - e1*f1*h2 - d2*e1*i1 - 
   ...
   h2*(8*a2*b1*c1 + 8*a1*b2*c1 + 8*a1*b1*c2 - 4*c1*d1*d2 - 
      4*a1*e1*e2 + 2*d2*e1*f1 + 2*d1*e2*f1 + 2*d1*e1*f2 - 
      4*b1*f1*f2 - 2*c2*d1_2 - 2*a2*e1_2 - 
      2*b2*f1_2)*(2*c2*d2*g2 - e2*f2*g2 - 
      4*a2*c2*h2 + 2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   2*b2*(2*c2*d1*g1 + 2*c1*d2*g1 - e2*f1*g1 - e1*f2*g1 + 
      2*c1*d1*g2 - e1*f1*g2 - 4*a2*c1*h1 - 4*a1*c2*h1 + 
      2*f1*f2*h1 - 4*a1*c1*h2 + 2*a2*e1*i1 + 2*a1*e2*i1 - 
      d2*f1*i1 - d1*f2*i1 + 2*a1*e1*i2 - d1*f1*i2 + 
      h2*f1_2)*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   ...
   a2*pow(-4*b2*c2*g1 - 4*b2*c1*g2 - 4*b1*c2*g2 + 
      ...
      2*c1*d2*h2 - e2*f1*h2 - e1*f2*h2 - d2*e2*i1 + 
      2*b2*f2*i1 - d2*e1*i2 - d1*e2*i2 + 2*b2*f1*i2 + 
      2*b1*f2*i2 + g1*e2_2,2) + 
   j2*pow(8*a2*b2*c1 + 8*a2*b1*c2 + 8*a1*b2*c2 - 
      4*c2*d1*d2 - 4*a2*e1*e2 + 2*d2*e2*f1 + 2*d2*e1*f2 + 
      2*d1*e2*f2 - 4*b2*f1*f2 - 2*c1*d2_2 - 
      2*a1*e2_2 - 2*b1*f2_2,2) + 
   ...
   f2*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - d2*f2*h2 - 
    ...
    (-(d2*e2*g1) + 2*b2*f2*g1 - d2*e1*g2 - d1*e2*g2 + 
      ...
      2*a2*e1*h2 + 2*a1*e2*h2 - d2*f1*h2 - d1*f2*h2 - 
      4*a2*b2*i1 - 4*a2*b1*i2 - 4*a1*b2*i2 + 2*d1*d2*i2 + 
      i1*d2_2)*(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - 
      d2*e2*i2 + 2*b2*f2*i2 + g2*e2_2) + 
   ...
   e2*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - d2*f2*h2 - 
    ...
    (-(d2*e2*g1) + 2*b2*f2*g1 - d2*e1*g2 - d1*e2*g2 + 
      ...
      2*a2*e1*h2 + 2*a1*e2*h2 - d2*f1*h2 - d1*f2*h2 - 
      4*a2*b2*i1 - 4*a2*b1*i2 - 4*a1*b2*i2 + 2*d1*d2*i2 + 
      i1*d2_2)*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   d2*(-4*b2*c2*g1 - 4*b2*c1*g2 - 4*b1*c2*g2 + 
      2*e1*e2*g2 + 2*c2*d2*h1 - e2*f2*h1 + 2*c2*d1*h2 + 
      2*c1*d2*h2 - e2*f1*h2 - e1*f2*h2 - d2*e2*i1 + 
   ...
   h2*(8*a2*b2*c1 + 8*a2*b1*c2 + 8*a1*b2*c2 - 4*c2*d1*d2 - 
      4*a2*e1*e2 + 2*d2*e2*f1 + 2*d2*e1*f2 + 2*d1*e2*f2 - 
      4*b2*f1*f2 - 2*c1*d2_2 - 2*a1*e2_2 - 
      2*b1*f2_2)*(2*c2*d2*g2 - e2*f2*g2 - 
      4*a2*c2*h2 + 2*a2*e2*i2 - d2*f2*i2 + h2*f2_2) + 
   2*b2*(2*c2*d2*g1 - e2*f2*g1 + 2*c2*d1*g2 + 2*c1*d2*g2 - 
      e2*f1*g2 - e1*f2*g2 - 4*a2*c2*h1 - 4*a2*c1*h2 - 
      4*a1*c2*h2 + 2*f1*f2*h2 + 2*a2*e2*i1 - d2*f2*i1 + 
      2*a2*e1*i2 + 2*a1*e2*i2 - d2*f1*i2 - d1*f2*i2 + 
      h1*f2_2)*(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2);
	rtc[6]=
		f2*(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - d2*f2*h2 - 
      4*a2*b2*i2 + i2*d2_2)*
   ...
   d2*(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - d2*e2*i2 + 
    ...
    (2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 2*a2*e2*i2 - 
      d2*f2*i2 + h2*f2_2) + 
   h2*(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2)*
    (2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 2*a2*e2*i2 - 
      d2*f2*i2 + h2*f2_2) + 
   c2*pow(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - 
      d2*f2*h2 - 4*a2*b2*i2 + i2*d2_2,2) + 
   a2*pow(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - d2*e2*i2 + 
      2*b2*f2*i2 + g2*e2_2,2) + 
   j2*pow(8*a2*b2*c2 + 2*d2*e2*f2 - 2*c2*d2_2 - 
      2*a2*e2_2 - 2*b2*f2_2,2) + 
   b2*pow(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 
      2*a2*e2*i2 - d2*f2*i2 + h2*f2_2,2);
	...
	bool found=false;
	REAL deepest = 0;
    REAL lamda_k_2, lamda_k_3;
	for (int k=0;k<jj;k++){
	    x=0;
	    y=0;
	    z=0;
	    within=0;
        lamda_k_2 = pow(lamda[k],2);
        lamda_k_3 = pow(lamda[k],3);
            det=
	                8*a1*b1*c1 + 2*d1*e1*f1 - 2*c1*d1_2 - 
			2*a1*e1_2 - 2*b1*f1_2 + 
			...
			2*d2*e1*f2 + 2*d1*e2*f2 - 4*b2*f1*f2 - 
			2*c1*d2_2 - 2*a1*e2_2 - 2*b1*f2_2)*
			lamda_k_2 + (8*a2*b2*c2 + 2*d2*e2*f2 - 
			2*c2*d2_2 - 2*a2*e2_2 - 2*b2*f2_2)*
	                lamda_k_3;
		...
		x=
			...
			g1*e2_2)*lamda_k_2 + 
			(-4*b2*c2*g2 + 2*c2*d2*h2 - e2*f2*h2 - d2*e2*i2 + 
			 2*b2*f2*i2 + g2*e2_2)*lamda_k_3) )/det;
		y=
			...
			h1*f2_2)*lamda_k_2 + 
			(2*c2*d2*g2 - e2*f2*g2 - 4*a2*c2*h2 + 2*a2*e2*i2 - 
			 d2*f2*i2 + h2*f2_2)*lamda_k_3) )/det;
		z=
			...
			2*d1*d2*i2 + i1*d2_2)*lamda_k_2 + 
			(-(d2*e2*g2) + 2*b2*f2*g2 + 2*a2*e2*h2 - d2*f2*h2 - 
			 4*a2*b2*i2 + i2*d2_2)*lamda_k_3) )/det;

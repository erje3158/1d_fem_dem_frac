...
if [ "$#" = 2 ]
	...
	if [ "$1" = "excalibur" ]
		...
		then
			echo "Running Hierarchical Upscaling Code on onyx.erdc.hpc.mil"
			cd ./source/onyx/
		...
		echo "--> Need to specify recognized platform: excalibur, topaz, macOS, copper, onyx, or soilblast"
	...
	echo "--> ./Submit_Script.sh <platform> <PBS script>"
	echo "--> Current platforms: excalibur, topaz, macOS, copper, onyx, or soilblast"
